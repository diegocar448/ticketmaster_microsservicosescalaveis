// apps/event-service/src/common/pipes/zod-validation.pipe.ts
//
// Pipe NestJS que valida o body usando um Zod schema.
// Se inválido: retorna 400 com erros detalhados (mas seguros — não expõe stack trace).
//
// Por que Zod em vez de class-validator?
//   Zod schemas são compartilháveis entre frontend e backend via @showpass/types.
//   class-validator usa decoradores e não funciona fora do contexto NestJS.
